...
<head>
    ...
    <title>Tiki | Đăng ký tài khoản</title>
...
<body>
    <header class="row">
        ...
        <span style="width: 250px;">Đăng ký</span>
    </header>
    <main>
        ...
        <div class="main-right col-sm-6">
            <form>
                <div class="header p-2 text-uppercase fw-bold">Đăng Ký</div>
                <div class="body">
                    <input name="email" type="text" placeholder="Nhập Email">
                    <button type="submit" class="text-uppercase">Tiếp theo</button>
                    <hr>
                    <div class="different">
                        <a href="#">
